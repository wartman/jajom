...
describe('Jajom', function () {
  ...
  describe('#Property', function () {
    ...
    it('enforces strict types', function () {
      var Test = Jajom.Class.extend({
        foo: Jajom.Property({type: 'String', value: 'hey'})
      })
      var test = new Test()
      expect(test.foo()).to.equal('hey')
      test.foo('foo')
      expect(test.foo()).to.equal('foo')
      expect(function () {
        test.foo(1)
